...
namespace CaptchaDotNet2
{
    ...
    public class CaptchaImage
    {
        ...
        private void GenerateImage()
        {
            ...
            SolidBrush sBrush = new SolidBrush(Color.FromArgb(255,100,100));
            ...
            using (Bitmap copy = (Bitmap)bitmap.Clone())
            {
                for (int y = 0; y < height; y++)
                {
                    ...
                    {
                        // Adds a simple wave
                        int newX = (int)(x + (Math.Sin(Math.PI * y / 84.0)));
                        int newY = (int)(y + (Math.Cos(Math.PI * x / 44.0)));
