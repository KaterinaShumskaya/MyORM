...
namespace Persons
{
    ...
    class ListAccessorTests
    {
        ...
        public void TestSetUp()
        {
            ...
            _accessor = new ListPersonAccessor(_persons);
        }
        ...
        {
            IList<Person> persons = _accessor.GetByLastName("Иванов");
            persons.Should().NotBeNull();
            persons.ShouldBeEquivalentTo(
                new List<Person> {new Person("Иванов", "Иван", "Иванович", 20)});
        }
        ...
        {
            _accessor.DeleteByLastName("Иванов");
            IList<Person> persons = _accessor.GetAll();
